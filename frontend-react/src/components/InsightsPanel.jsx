    ...
    <>
      ...
      <div className="sidebar-header rp-header">
        ...
        <div className="rp-topbar-right">
          ...
          {onCollapse && (
            <button className="sidebar-toggle-btn rp-collapse-btn matte-glass" onClick={onCollapse} title="Collapse panel">
          ...
          {onCloseMobile && (
            <button className="rp-close-btn" onClick={onCloseMobile} title="Close panel">×</button>
          )}
        </div>
      </div>
