...
// ============================================================================
// Superseded by pages/B2B.jsx (connections tab); /b2b-network redirects there.
// Its connect flow reflected the OLD auto-accept model — connections are now
// request->approve, so this UI was not merely redundant, it was WRONG.
//
