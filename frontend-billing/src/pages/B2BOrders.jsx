...
// ============================================================================
// Superseded by pages/B2B.jsx (outgoing tab). Its own header said it was
// 'retained only so the existing render test keeps a reference implementation
// to compare against; delete it once that test is retired'. That test
// (__tests__/B2BOrders.test.jsx) is ALSO commented out below, because its one
// behaviour — the 'Stock received' badge on a completed purchase order with a
// seller_invoice_id — is covered against the LIVE component by
// __tests__/B2BOrdersTab.test.jsx. The reason to retain this page is gone.
//
