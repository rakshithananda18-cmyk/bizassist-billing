    ...
    <div className="pos-top-bar">
          ...
          {tabs.map(tab => {
            ...
            return (
              ...
              >
                ...
                <span className="pos-tab-close" onClick={(e) => onCloseTab(tab.id, e)}>✕</span>
              </div>
            );
          })}
      ...
      <div className="pos-top-bar-right" style={{ gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 2 }}>
          ...
          <span className="pos-window-control-btn close-btn" style={{ width: 20, height: 20, fontSize: '0.75rem', cursor: 'pointer' }} onClick={onClose} title="Close POS">✕</span>
        </div>
      </div>
    </div>
  )
