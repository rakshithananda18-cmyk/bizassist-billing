...
// ============================================================================
// Catalogue browsing now lives in src/b2b/components/OrderDeskTab.jsx as a full
// tab rather than a modal — it takes `catalog`, resolves scans via findByCode,
// and prices through useOrderCart(catalog). VERIFIED before commenting out:
// nothing here needs porting. NOTE commit 5058dfc edited THIS file (7 lines),
// which is how a dead copy still receives work.
//
