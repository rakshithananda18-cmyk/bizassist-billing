...
**Companion docs:** [Full plan → `BIZASSIST_ECOSYSTEM_MASTER_PLAN.md`](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) · [Review → `PRODUCT_REVIEW.md`](PRODUCT_REVIEW.md) · [Hosting modes → `HOSTING_MODE_MASTER_PLAN.md`](HOSTING_MODE_MASTER_PLAN.md) · [DoD gate → `PHASE_COMPLETION_CHECKLIST.md`](PHASE_COMPLETION_CHECKLIST.md)
...
→ Detail: [full plan §1, §3](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md)
...
→ Detail + rationale: [full plan §2](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md)
...
→ Detail: [full plan §4–§5](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) · [`HOSTING_MODE_MASTER_PLAN.md`](HOSTING_MODE_MASTER_PLAN.md) · [`PRODUCT_REVIEW.md` §B1](PRODUCT_REVIEW.md)
...
- ⚠️ **Open item S-1:** RLS is *fail-open* when tenant context is unset → harden to fail-closed. See [`PRODUCT_REVIEW.md` §B2](PRODUCT_REVIEW.md).
→ Detail: [full plan §6](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md)
...
→ Authoritative tracker: [full plan §10.0](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) · gaps & evidence: [`PRODUCT_REVIEW.md` §B3–B4](PRODUCT_REVIEW.md)
...
→ Detail + marketing hierarchy: [full plan §14, §16](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md)
...
→ Detail: [full plan §12](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) · [`PRODUCT_REVIEW.md` Part A](PRODUCT_REVIEW.md)
...
→ Detail: [full plan §13](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md)

## 9. Cardinal rules + Definition of Done
Read [full plan §15 (cardinal rules)](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) and [§16 (strength doctrine)](BIZASSIST_ECOSYSTEM_MASTER_PLAN.md) before every phase. Ship nothing without the 3 gates in [`PHASE_COMPLETION_CHECKLIST.md`](PHASE_COMPLETION_CHECKLIST.md): tests green + named · logging · plan updated.
