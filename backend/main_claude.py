...
# Restrict CORS to an explicit allowlist. Set ALLOWED_ORIGINS in the environment
# as a comma-separated list of frontend origins, e.g.
#   ALLOWED_ORIGINS=https://app.bizassist.com
# The default covers local development: opening index.html as a file sends
# "Origin: null"; running it via a local web server uses localhost:5500/3000.
