    ...
    if preview:
        ...
        for idx, it in enumerate(items):
            ...
            out.append({
                ...
                "hsn_sac": it.get("hsn_sac") or it.get("hsn") or None,
                ...
                "wholesale_price": it.get("wholesale_price") or 0,
                "distributor_price": it.get("distributor_price") or 0,
                "cost_price": it.get("cost_price") or 0,
                "mrp": it.get("mrp") or None,
                "cgst_rate": it.get("cgst_rate") or 0,
                "sgst_rate": it.get("sgst_rate") or 0,
                "igst_rate": it.get("igst_rate") or 0,
