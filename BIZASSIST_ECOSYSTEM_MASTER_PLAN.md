...
**R5 — Decompose god-components · M · medium risk · frontend — [🟡 IN PROGRESS]**
...
- *Approach (remaining R5):* split `Reports.jsx` (the 7-branch render ternary) into one component per report behind a registry/map. Each piece gets a render test.
